    ...
    <div className="pt-24 pb-24">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-6xl font-display font-bold uppercase">Contato</h1>
          <div className="w-24 h-1 bg-brand mx-auto mt-6"></div>
        </div>

        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16">
          <div className="space-y-8">
            <h3 className="text-3xl font-display font-bold uppercase mb-8 leading-tight">Vamos Levar o <br /> Taiko até Você</h3>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-lg">contato@tatakinan.com.br</p>
                </div>
              </div>
              <div className="flex items-center gap-6 group">
                <div className="w-14 h-14 bg-brand/10 text-brand rounded-full flex items-center justify-center group-hover:bg-brand group-hover:text-white transition-all">
            ...
            <div className="flex gap-4 pt-4">
              <a href="#" className="w-12 h-12 bg-white/5 hover:bg-brand text-white rounded-full flex items-center justify-center transition-all"><Instagram size={20} /></a>
              <a href="#" className="w-12 h-12 bg-white/5 hover:bg-brand text-white rounded-full flex items-center justify-center transition-all"><Music size={20} /></a>
              <a href="#" className="w-12 h-12 bg-white/5 hover:bg-brand text-white rounded-full flex items-center justify-center transition-all"><Mail size={20} /></a>
            </div>
          </div>
